...
class Musician {
    ...
    init(instruments: [String], musicStyle: String, name: String) {
...
let musician = Musician(instruments: ["Drums"], musicStyle: "Forró", name: "Ana")

var musicians = [Musician]()

musicians.append(musician)

let musician2 = Musician(instruments: ["Sax"], musicStyle: "Black music", name: "Andressa")

musicians.append(musician2)

print(musician2.instruments)
